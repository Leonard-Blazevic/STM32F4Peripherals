...
{   
  ...
  if ( Xval>Yval)
  {
    if ((int16_t)Buffer[0] > 40)
    {
      ...
      LCD_SetFont(&Font16x24);
			...
			LCD_DisplayStringLine(LINE(1), (uint8_t*)"1");
      Delay(50);
    }
    if ((int16_t)Buffer[0] < -40)
    {
      ...
      LCD_SetFont(&Font16x24);
			/*Print sting on LCD line 5*/
			LCD_DisplayStringLine(LINE(1), (uint8_t*)"2");
      Delay(50);
    }
  }
  else
  {
    if ((int16_t)Buffer[1] < -40)
    {
      ...
      LCD_SetFont(&Font16x24);
			/*Print sting on LCD line 5*/
			LCD_DisplayStringLine(LINE(1), (uint8_t*)"3");      
      Delay(50);
    }
    if ((int16_t)Buffer[1] > 40)
    {      
      ...
      LCD_SetFont(&Font16x24);
			/*Print sting on LCD line 5*/
			LCD_DisplayStringLine(LINE(1), (uint8_t*)"4");
      Delay(50);
    } 
  } 
}
